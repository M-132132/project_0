...
def read_NGSIM_tracks_csv(track_csv_path):
    """
    This method reads the tracks file from highD data which is generated from NGSIM data.
...
def read_tracks_static(tracks_meta_path):
    """
...
def read_NGSIM_tracks_static(tracks_meta_path):
    """
    This method reads the static info file from highD data.
...
def read_NGSIM_recording_meta(recording_meta_path):
    """
    This method reads the video meta file from highD data.
