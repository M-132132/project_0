...
from models.smart.modules import SMARTDecoder
...
class SMART(pl.LightningModule):
    ...
    def save_scene(
        ...
        save_dir="/home/zxq/ws/TrajAttr/TrajAttr/models/smart/scene_rep_compare/TrajAttr",
    ):
        save_dir = os.path.join(save_dir, f"{data['scenario_id'][0][0]}")
        if not os.path.exists(save_dir):
            os.makedirs(save_dir)
    ...
    def save_data(
        ...
        data_filename="data.pkl",
        pred_filename="pred.pkl",
        save_dir="/home/zxq/ws/SMART/waymax_submission/TrajAttr",
    ):
        # def save_data(self, data, data_filename="scene_rep_new.pkl", save_dir="/home/zxq/ws/TrajAttr/TrajAttr/models/smart/scene_rep_compare/TrajAttr"):
        save_dir = os.path.join(save_dir, f"{data['scenario_id'][0][0]}")
        if not os.path.exists(save_dir):
            os.makedirs(save_dir)
    ...
    # def save_traj(self, pred, target, pred_filename="pred.pkl", target_filename="target.pkl", save_dir="/home/zxq/ws/TrajAttr/waymax_sub/test"):
    def save_traj(
        self,
        pred,
        target,
