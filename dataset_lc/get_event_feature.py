...
def cnn_fc_main():
    data_save_dir_name = 'data_dop_test'
    if not os.path.exists(data_save_dir_name):
        os.makedirs(data_save_dir_name)
    ...
    for subset_name, subset in zip(["training", "testing"], [training_set, testing_set]):
        filename = f"{data_save_dir_name}/result_{subset_name}_{FEATURE_CHOICE}.pickle"
